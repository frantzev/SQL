...
public class VerificationPage {
    ...
    private final SelenideElement verifyButton = $("[type='button']");
    private final SelenideElement validationMessageEmptyCode = $(".input__sub");
    private final SelenideElement errorMessageInvalidCode = $("[data-test-id='error-notification'] .notification__content");
