...
public class LoginPage {
    ...
    private final SelenideElement validationMessageEmptyLogin = $$(".input__sub").first();
    private final SelenideElement validationMessageEmptyPassword = $$(".input__sub").last();
    private final SelenideElement errorMessageInvalidAuthInfo = $("[data-test-id='error-notification'] .notification__content");
    private final SelenideElement errorMessageCloseButton = $(".icon_name_close");
    private final SelenideElement errorMessageBlockedSystem = $("[data-test-id='block-notification'] .notification__content");
